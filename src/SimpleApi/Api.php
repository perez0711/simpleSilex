...
use SimpleApi\Controller\Api\LoginController;
use Symfony\Component\HttpFoundation\Response;
use Symfony\Component\HttpFoundation\Request;

class Api extends AbstractControllerProvider implements ControllerProviderInterface
{
    public function connect(Application $app)
    {
        ...
        LoginController::addRoutes($controllers);
